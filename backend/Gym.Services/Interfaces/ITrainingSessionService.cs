...
public interface ITrainingSessionService
{
    ...
    Task<TrainingSessionDto> CreateAsync(int actorUserId, bool isAdmin, CreateTrainingSessionDto dto);
    Task DeleteAsync(int id, int actorUserId, bool isAdmin);
    Task<SessionReservationDto> ReserveAsync(int userId, int sessionId);
    Task CancelReservationForSessionAsync(int userId, int sessionId, string? cancellationReason = null);
